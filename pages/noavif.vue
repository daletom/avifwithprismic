      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          ...
          <PopoverGroup as="nav" class="hidden md:flex space-x-10">
            ...
            <a href="/noavif" class="text-base font-medium text-gray-500 hover:text-gray-900">
              Without Avif
            </a>
                      ...
                      <div>
                        ...
                        <ul role="list" class="mt-4 space-y-4">
                          <li v-for="item in recentPosts" :key="item.id" class="text-base truncate">
                            <a class="font-medium text-gray-900 hover:text-gray-700">
                              {{ item.name }}
                            </a>
                          </li>
                        </ul>
          ...
          <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            ...
            <div class="py-6 px-5 space-y-6">
              <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                ...
                <a href="/noavif" class="text-base font-medium text-gray-900 hover:text-gray-700">
                  Without Avif
                </a>
    ...
    <main class="lg:relative">
      ...
      <div class="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">
        <img
          ...
          src="https://images.prismic.io/avif/1f4c1c26-54ff-4f74-bdfc-80a226b823c1_photo-1520333789090-1afc82db536a.jpeg?auto=compress&fm=webp&w=720"
          srcset="https://images.prismic.io/avif/1f4c1c26-54ff-4f74-bdfc-80a226b823c1_photo-1520333789090-1afc82db536a.jpeg?auto=compress&fm=webp&w=720 1x, https://images.prismic.io/avif/1f4c1c26-54ff-4f74-bdfc-80a226b823c1_photo-1520333789090-1afc82db536a.jpeg?auto=compress&fm=webp&w=720&dpr=2 2x"
          alt=""
        />
      </div>
    </main>
  ...
  <div class="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
    ...
    <div class="relative max-w-7xl mx-auto">
      ...
      <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
        <div v-for="item in recentPosts" :key="item.id" class="flex flex-col rounded-lg shadow-lg overflow-hidden">
          <div class="flex-shrink-0">
            <img class="h-48 w-full object-cover" :src="item.imageUrl" :srcset="item.imageUrl + ' 1x, ' + item.imageUrl + '&dpr=2 2x'" alt="" />
          </div>
          <div class="flex-1 bg-white p-6 flex flex-col justify-between">
            ...
            <div class="mt-6 flex items-center">
              <div class="flex-shrink-0">
                <a>
                  <span class="sr-only">{{ item.author }}</span>
                  <img class="h-10 w-10 rounded-full" :src="item.authorImageUrl" :srcset="item.authorImageUrl + ' 1x, ' + item.authorImageUrl + '&dpr=2 2x'" alt="" />
                </a>
              </div>
              <div class="ml-3">
...
const recentPosts = [
  { id: 1, name: 'Boost your conversion rate', href: '#', imageUrl: 'https://images.prismic.io/avif/abb9c03f-07ac-4705-a5d5-f2fdd457c90c_tezos-Lh3HAnw8RtU-unsplash.jpg?auto=compress&fm=webp&w=400', category: 'science', description: 'This is a blog.', author: 'Tom', authorImageUrl: 'https://images.prismic.io/avif/82db267a-f17d-467f-b6db-0f409a669416_krennic_profile.png?w=40&auto=compress&fm=webp', date: 'March 21, 2021', readingTime: '5 mins' },
  { id: 2, name: 'How to use search engine optimization to drive traffic to your site', href: '#', imageUrl: 'https://images.prismic.io/avif/c9d84d89-3344-4c8b-92aa-95fe00b45096_xps-4TBSG2Oqu0Q-unsplash.jpg?auto=compress&fm=webp&w=400', category: 'science', description: 'This is a blog.', author: 'Tom', authorImageUrl: 'https://images.prismic.io/avif/82db267a-f17d-467f-b6db-0f409a669416_krennic_profile.png?w=40&auto=compress&fm=webp', date: 'March 21, 2021', readingTime: '5 mins' },
  { id: 3, name: 'Improve your customer experience', href: '#', imageUrl: 'https://images.prismic.io/avif/4ab53c42-3f07-4b19-9555-e994a80fde6e_annie-spratt-G2WMEpRCCNA-unsplash.jpg?auto=compress&fm=webp&w=400', category: 'science', description: 'This is a blog.', author: 'Tom', authorImageUrl: 'https://images.prismic.io/avif/82db267a-f17d-467f-b6db-0f409a669416_krennic_profile.png?w=40&auto=compress&fm=webp', date: 'March 21, 2021', readingTime: '5 mins' },
]
